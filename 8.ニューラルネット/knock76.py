...
os.makedirs('output/output76', exist_ok=True)
output_file = 'output/output76/output76.txt'
...
# 重みとテンソルのバイアスのみ保存
torch.save(model.state_dict(), 'output/output76/logistic_regression_model.pth')
# モデルの保存
torch.save(model, 'output/output76/logistic_regression_full_model.pth')